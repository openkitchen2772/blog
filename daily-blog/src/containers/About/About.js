    ...
    return (
        <div className={showAbout ? [classes.About, classes.Show].join(' ') : classes.About}>
            <div className={classes.Content}>
                ...
                <p>Software developer from Hong Kong, passionate in building application and exploring problem-solving innovation.</p>
                <p><FontAwesomeIcon icon={faICursor} style={{ color: "#888888", marginLeft: "5px", marginRight: "15px" }} />Javascript, GoLang, C#</p>
                <p><FontAwesomeIcon icon={faToolbox} style={{ color: "#888888", marginRight: "10px" }} />NextJS, ReactJS, GoLang(Web Server), Docker, MongoDB</p>
